...
export const apIsDescription: INodeProperties[] = [
			...
			"options": [
				{
					"name": "Cemst",
					"value": "Cemst",
					"action": "Class VIII Marksheet",
					"description": "API to verify Class VIII Marksheet.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/cemst/certificate"
						}
					}
				},
				{
					"name": "Cfmst",
					"value": "Cfmst",
					"action": "Class V Marksheet",
					"description": "API to verify Class V Marksheet.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/cfmst/certificate"
						}
					}
				},
				{
				...
				},
				{
					"name": "Micer",
					"value": "Micer",
					"action": "Migration Certificate",
					"description": "API to verify Migration Certificate.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/micer/certificate"
						}
					}
				},
				{
		...
		{
			"displayName": "POST /cemst/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /cfmst/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /micer/certificate",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
